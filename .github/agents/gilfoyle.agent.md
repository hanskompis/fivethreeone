...
tools: ['changes', 'codebase', 'web/fetch', 'problems', 'read', 'search', 'searchResults', 'terminalLastCommand', 'terminalSelection', 'usages']
handoffs:
  - label: Start Fixes
    agent: torvalds 
    prompt: Now fix issues found and implement improvements
    send: false
---
